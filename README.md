...
## MacOS Binary notes
The precompiled MacOS component, vst3 and standfalone app have not been signed/notarized and so to extract and run them you'll need to perform the following Terminal commands. Note if you compile them yourself this is unecessary.
