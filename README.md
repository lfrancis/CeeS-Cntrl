...
**Logic Pro**: Requires Logic Pro 11.1.2 or later. Export the app as an _AU MIDI Effect_ type plug-in. After launching Logic and clicking your channel strip _MIDI FX_ plug-in button, search for the app by name or drill down to the _Audio Units > CabbageAudio >_ folder. Apply this plug-in to the channel strip hosting your CS synth MIDI track.
...
**Reaper**: Export the app as a _VST3 Synth_ type plug-in and flter plug-in view by Cabbage. Make sure you route the MIDI output to your CS. 
...
* Removing Quarantine from an App or Plug-in: Use sudo xattr -r -d com.apple.quarantine /path/to/file.whatever.
