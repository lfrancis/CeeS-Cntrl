...
CeeS Cntrl was created with the [Cabbage Audio Framework](https://cabbageaudio.com) 2.10.7 and can run as a DAW plug-in as either AU or VST, and as a standalone app on MacOS, WinOS and Linux machines. 
